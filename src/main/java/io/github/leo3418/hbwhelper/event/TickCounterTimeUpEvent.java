...
public class TickCounterTimeUpEvent extends Event {
    /**
     * The {@link TickCounter} object which fires this event
     */
     ...
     *
     * @param expiringCounter the {@link TickCounter} object which fires this
     *         event
     */
    ...
    /**
     * Returns the {@link TickCounter} object which fires this event.
     *
